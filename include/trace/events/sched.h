...
TRACE_EVENT(sched_get_nr_running_avg,
	...
	TP_printk("wc %llu ws %llu delta %llu avg=%d big_avg=%d iowait_avg=%d event %d cpu %d cur_pid %d task %d (%s) ms %llu delta %llu max_nr=%u big_max_nr=%u demand %u sum %u irqtime %llu"
